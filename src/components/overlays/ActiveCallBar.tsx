...
import { useCallActions, useCallingStore } from '@/src/hooks/useCallingStore'
import { Phone, Volume, VolumeOff } from 'lucide-react'
...
export default function ActiveCallBar() {
    const { muted, callData } = useCallingStore()
